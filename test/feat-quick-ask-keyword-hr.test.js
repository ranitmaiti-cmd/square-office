...
(async () => {
  ...
  check('renderApprovals() is byte-for-byte unchanged from main', extractFunction(fullScript, 'renderApprovals').src === extractFunction(mainFullScript, 'renderApprovals').src);
